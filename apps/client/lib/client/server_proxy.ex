defmodule ServerProxy do
  ...
  def init(server_name) do
    { node_address, client_proxy_name } = IGameMaker.new_game({ GameMaker, server_name }, self()) # TODO: ver
    Node.connect(node_address)
    state = %{} # TODO: ver

    {:ok, {{ node_address, client_proxy_name }, state}}
  end
